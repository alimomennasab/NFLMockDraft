...
let prospects: string[] = ['Caleb Williams', 'Jayden Daniels', 'Drake Maye']
let prospectsSize: number = prospects.length

console.log('The 2024 NFL draft has begun!\n')
  ...
  while (Object.keys(draftOrder).length > 0) {
    ...
    switch (choice) {
      case 1: {
        ...
        if (
          prospectSelection >= 0 &&
          prospectSelection < prospects.length &&
          prospects[prospectSelection]
        ) {
          console.log(
