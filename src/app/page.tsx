...
export default function Page() {
  ...
  const handleRoundChange = (round: number) => {
    setSelectedRound(round); // Update selected round
  };
        ...
        <div className='md:max-w-5xl flex flex-col items-center w-full'>
          ...
          <div className='flex flex-col items-center mt-3 w-full'>
            ...
            <div className='flex justify-center items-center'>
              ...
              <Button className='bg-green-600 text-white p-3 flex justify-center max-w-sm m-3 rounded-lg hover:bg-green-700'>
                Start Draft
              </Button>
            </div>
          </div>
